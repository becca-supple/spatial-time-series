...
Please cite the following pre-print if any of the algorithms or helper functions are used:

Supple, R.F., Worthington, H., and Swallow, B. (2026). Discovering causal relationships between time series with spatial structure. https://arxiv.org/abs/2510.26485.

Please cite the poster if referring to the simulation or garden bird studies:

Supple, R.F., Worthington, H., and Swallow, B. (2026, March 4). _Discovering causal relationships between time series with spatial structure_ \[Poster presentation\]. Causal Identification and Discovery Workshop, Isaac Newton Institute, Cambridge, United Kingdom. https://becca-supple.github.io/files/posters/INI%20Poster.pdf.
